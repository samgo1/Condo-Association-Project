...
<div class="gridcontainer">
    ...
    <div class="menubar">
        ...
        <?php if ($user_signed_in&& $_SESSION['privilege'] == 'admin') echo "<button onClick=\"show('condos')\">Condos</button>" ?>
        <?php if ($user_signed_in && $_SESSION['privilege'] == 'admin') echo "<button onClick=\"show('requests')\">Requests</button>" ?>
